...
export const metadata = {
  title: "Zh-szimulátor",
  description: "Nyolc véletlen statikafeladat órával, segítség nélkül — mint a zárthelyin. Eredmény, levezetés, mentett előzmények.",
};
      ...
      <div className="racs-hatter border-b border-petrol-800 bg-linear-to-br from-petrol-900 via-petrol-800 to-petrol-700">
        <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
          ...
          <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-petrol-200">
            Nyolc feladat, egy minden modulból, órával és visszajelzés nélkül — ahogy a zárthelyin. A végén
