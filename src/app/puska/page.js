...
import PuskaTerbeli from "@/components/terbeli/Puska";
    ...
    <>
      <div className="racs-hatter nyomtatasban-rejtve border-b border-petrol-800 bg-linear-to-br from-petrol-900 via-petrol-800 to-petrol-700">
        <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
          ...
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-white sm:text-4xl">Puska — tizenegy lap</h1>
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 print:max-w-none print:p-0">
        ...
        <Lap szam={11} cim="Térbeli tartók" gyerekek={<PuskaTerbeli Doboz={Doboz} />} />
      </div>
    </>
  );
}
